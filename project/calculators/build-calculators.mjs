...
${c.slug === 'acquisition-tax' ? `    <section class="jt-cc-sec">
    ...
    <section class="jt-cc-sec">
      ...
      <div class="jt-cc-chips" style="margin-top:12px;">
        <a class="jt-cc-chip" href="/#/report/acq-check">내가 낸 취득세 점검 접수 →</a>
...
${otherCalcs}
    ...
    <div class="jt-cc-cta" style="margin-top:24px;">
      ...
      <a href="https://pf.kakao.com/_CcxlJG" class="jt-btn jt-btn--outline" target="_blank" rel="noopener" onclick="jtTrackCta('kakao','calc_bottom')">카톡 상담</a>
    </div>
  </main>
