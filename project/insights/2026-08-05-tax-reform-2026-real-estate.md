...
「폐지된다」는 이야기가 돌지만 정확하지 않습니다. **최대 공제율 80%는 그대로 유지**되며, 그 80%를 채우는 방법이 보유에서 거주로 옮겨 가는 것입니다. 지금 적용되는 요건이 궁금하시면 [1세대 1주택 비과세·장기보유특별공제 현행 기준](/insights/one-house-cgt-exemption.html)을 먼저 보시면 비교가 쉽습니다.
...
종합부동산세 정상화에 따라 매도 기회를 주려는 취지의 한시 조치입니다. 완화 이전의 원래 구조는 [다주택 양도세 중과 정리](/insights/multi-house-cgt-surcharge-2026.html)에서 확인할 수 있습니다.
...
현행은 1세대 1주택자에게 일률적으로 12억 원을 공제합니다([현행 종부세 계산법과 공시가격별 세액](/insights/comprehensive-real-estate-tax-2026.html) 참조). 개편안은 이를 둘로 나눕니다.
