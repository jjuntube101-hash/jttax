...
세율을 정하는 판단이 모두 취득일을 기준으로 이루어집니다. 세대는 주택 취득일 현재를 기준으로 보고(지방세법 시행령 제28조의3 제1항), 세율 적용의 기준이 되는 1세대의 주택 수도 주택 취득일 현재를 기준으로 셉니다(같은 시행령 제28조의4 제1항). 그 주택이 조정대상지역에 있는 주택인지도 함께 봅니다(지방세법 제13조의2 제1항 제2호).
