...
- 주택 전체를 단독으로 상속받았던 경우는 「공유지분」이라는 문언에 들어가지 않습니다. 다만 같은 항 제2호 다목이 도시지역이 아닌 지역이나 면의 행정구역에 있는 상속 취득 주택을 따로 정하고 있으므로, 여섯 호 전체를 봅니다. 여섯 호는 [예전에 작은 집이 있었는데 생애최초 감면이 되나요](/insights/acquisition-tax-first-home-no-house-test.html)에 정리했습니다.
