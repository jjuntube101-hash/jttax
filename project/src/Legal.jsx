  ...
  const privacy = (
    <>
      ...
      <ul>
        ...
        {/* ⚠️ 260921 신설 — 「내가 낸 취득세 점검」 접수(재계산기가 아니라 서류 점검 접수)는
            이름·연락처가 아니라 «연락 방법»만 필수다. 화면 동의문(ReportAcqCheck.jsx)과
            같은 항목을 써야 하고, 어긋나면 방침이 거짓 고지가 된다. */}
        <li><strong>내가 낸 취득세 점검 접수</strong> — 필수: 연락 방법(전화를 고르신 경우 전화번호) / 선택: 취득일, 소재지 시·도, 취득 원인, 물건 종류, 명의와 지분, 신고서상 세목별 금액, 실제 납부액과 납부일, 이후 수정신고·경정·환급·추가 고지 이력, 통지서 종류와 수령일, 자료를 보고 적었는지 여부 — 시·군·구·동·호수·주민등록번호는 받지 않으며, 선택 항목은 비워 두셔도 접수됩니다</li>
