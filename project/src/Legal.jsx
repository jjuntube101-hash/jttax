  ...
  const privacy = (
    <>
      ...
      <ul>
        ...
        <li><strong>내가 낸 취득세 점검 접수</strong> — 필수: 연락 방법(전화를 고르신 경우 전화번호) / 선택: 취득일, 소재지 시·군·구, 취득 원인, 물건 종류, 명의와 지분, 신고서상 세목별 금액, 실제 납부액과 납부일, 이후 수정신고·경정·환급·추가 고지 이력, 통지서 종류와 수령일, 자료를 보고 적었는지 여부 — 동·호수·주민등록번호는 받지 않으며, 선택 항목은 비워 두셔도 접수됩니다</li>
