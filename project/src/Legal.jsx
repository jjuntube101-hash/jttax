  ...
  const privacy = (
    <>
      ...
      <ul>
        ...
        <li><strong>이미 낸 취득세 1차 재검토 접수</strong>(종전 「내가 낸 취득세 점검」) — 필수: 연락 방법(전화를 고르신 경우 전화번호) / 선택: 취득일, 소재지 시·도, 취득 원인, 물건 종류, 낸 취득세(대략), 지금 상황, 통지서 종류와 받은 날, 가지고 계신 서류(보유 여부만 — 서류 자체는 받지 않습니다), 알게 되신 경로(선택지) — 시·군·구·동·호수·주민등록번호는 받지 않으며, 자유 서술란도 없습니다</li>
