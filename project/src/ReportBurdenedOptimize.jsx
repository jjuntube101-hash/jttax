          ...
          {!calc.precise ? (
            ...
            <>
              ...
              <section className="jt-report-result__section" style={{ background: 'var(--bg-1,#f7f5f0)', borderLeft: '4px solid var(--accent,#2a6d4f)', padding: '16px 18px' }}>
                ...
                <p style={{ margin: '0 0 12px', lineHeight: 1.7 }}>세금만 보면 채무를 많이 끼울수록 좋아 보이지만, <strong>일정 비율을 넘으면 부당행위계산부인·실질과세로 절세가 통째로 사라지고 가산세</strong>까지 붙습니다. 또 증여자가 다주택이면 양도세가 달라져 최적이 바뀝니다. 위 「절세 여력」은 <strong>출발점</strong>이고, <strong>안전하면서 절세되는 실제 비율과 실행 순서는 세무사가 직접 설계</strong>해 드립니다.</p>
              </section>
