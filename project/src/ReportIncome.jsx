...
const INC_QS = [
  ...
  },
  {
    id: 'children',
    section: '부양가족',
    q: `그중 ${window.jtLaw('childTaxCredit.minAge', 13)}세 이상 자녀는 몇 명인가요? (자녀세액공제)`,
    sub: `위 부양가족 중 ${window.jtLaw('childTaxCredit.minAge', 13)}세 이상~${window.jtLaw('childTaxCredit.maxAge', 20)}세 이하 자녀 수. 1명 25만원·2명 55만원 등 자녀세액공제가 추가됩니다(소득세법 §59의2 · 2026.4.21 시행 ${window.jtLaw('childTaxCredit.minAge', 13)}세 상향, ${window.jtLaw('childTaxCredit.minAge', 13) - 1}세 이하는 대상 아님). 없으면 0.`,
    numeric: true, optional: true,
            ...
            <>
              ...
              <section className="jt-report-result__section" style={{ background: '#fff7ea', borderLeft: '4px solid #b8860b', padding: '14px 18px', borderRadius: 8 }}>
                ...
                <ul style={{ margin: 0, paddingLeft: 18, lineHeight: 1.7, fontSize: 14 }}>
                  ...
                  <li><strong>장부 작성(기장)</strong>: 장부 없이 추계신고하면 무기장가산세가 붙을 수 있고, 간편장부대상자가 복식부기로 기장하면 기장세액공제(산출세액 20%·한도 100만)를 받습니다(소득세법 §56의2). 업종별 경비율·기장 유불리는 상담에서 따져 드립니다.</li>
                </ul>
              </section>
