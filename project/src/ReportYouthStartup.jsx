...
const YS_QS = [
  ...
  },
  {
    ...
    sub: '청년이 아니어도 연 수입금액이 1억 4백만원 이하인 「소규모」 창업이면 청년과 같은 높은 감면율을 받습니다(§6⑥, 소규모 특례). 대략적인 연 매출을 넣으면 이 특례 적용 여부를 판정합니다.',
        ...
        <JTReportShell title="청년창업 세액감면 진단 결과" subtitle="조세특례제한법 §6 자동판정" stepIdx={total} stepTotal={total} onBack={() => setReport(null)} tag="NEW">
          ...
          {isProspective && (calc.region_scenarios || []).length > 0 && (
            <section className="jt-report-result__section">
              ...
              <p style={{ fontSize: 12.5, opacity: 0.7, marginTop: 8 }}>※ 수도권 인구감소지역 = 인천 강화·옹진, 경기 가평·연천 (2026년 이후 창업 기준). 청년이 아니어도 연 수입 1억 4백만원 이하 소규모면 청년과 같은 율을 받습니다.</p>
            </section>
          )}
